...
echo "Results will be in ${FILE}_results.txt, details in ${FILE}_details.txt and errors in ${FILE}_err.txt."
nohup ./mrun.py ${FILE} >> runs/${FILE}_details.txt 2>> runs/${FILE}_err.txt < /dev/null &
